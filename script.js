  ...
  var proverkaHods = function(kyda, otkyda, cvet, heyHod) {
    ...
    if(cvet.indexOf('okrugPlay1') != -1) {
        ...
        if(cvet.indexOf('okrugPlay1D') != -1) {
            ...
            koorKletkiHodaXPosle = koorKletkiHodaX - 1
                ...
                if(document.getElementById(koorKletkiHodaY * 10 + koorKletkiHodaX).innerHTML.indexOf('okrugPlay1') != -1) break;

                if(document.getElementById(koorKletkiHodaY * 10 + koorKletkiHodaX).innerHTML.indexOf('okrugPlay2') != -1) {

                    if(koorKletkiHodaYPosle == hislKyda[1] && koorKletkiHodaXPosle == hislKyda[0]) { //document.getElementById((hislOtkyda[1] - sizeHoda - 1) * 10 + hislOtkyda[0] - sizeHoda - 1).innerHTML == '' && 
            ...
            if(hislOtkyda[1] - sizeHoda == hislKyda[1] && (hislOtkyda[0] - sizeHoda == hislKyda[0])) {return true}
    ...
    if(cvet.indexOf('okrugPlay2') != -1) {
        ...
        if(cvet.indexOf('okrugPlay2D') != -1) {
                ...
                if(document.getElementById(koorKletkiHodaY * 10 + koorKletkiHodaX).innerHTML.indexOf('okrugPlay2') != -1) break;
                
                if(document.getElementById(koorKletkiHodaY * 10 + koorKletkiHodaX).innerHTML.indexOf('okrugPlay1') != -1) {
